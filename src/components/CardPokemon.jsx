    ...
    <div className="">
      {loading ? (
        ...
        <div className="max-w-7xl mx-auto ">
          <div className="custom-scroll-container mb-2">
            <div className="custom-scroll-content h-full grid grid-cols-[repeat(auto-fit,_minmax(200px,_1fr))] place-content-start justify-items-center gap-6">
              {pokemonList?.map(pokemon => (
                ...
                >
                  ...
                  <button className="w-[60%] card-button rounded-2xl  border-none bg-[#008bf8] text-white text-2xl absolute left-1/2 bottom-0 opacity-0 transition ease-out duration-[0.5s]  overflow-hidden ">
                    More info
                  </button>
                </div>
              ))}
